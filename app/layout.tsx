...
export const metadata: Metadata = {
  ...
  description: 'Create stunning album covers with our free Brat Generator! Design custom brat text generator artwork inspired by Charli XCX aesthetic. Professional brat font generator tools for instant high-quality downloads - completely free to use!',
  ...
  return (
    <html lang="en">
      <head>
        ...
        {/* Google Analytics */}
        <script async src="https://www.googletagmanager.com/gtag/js?id=G-DJELNT7LMX"></script>
